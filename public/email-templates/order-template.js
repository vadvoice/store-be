...
<body topmargin="0" rightmargin="0" bottommargin="0" leftmargin="0" marginwidth="0" marginheight="0" width="100%" style="border-collapse: collapse; border-spacing: 0; margin: 0; padding: 0; width: 100%; height: 100%; -webkit-font-smoothing: antialiased; text-size-adjust: 100%; -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%; line-height: 100%;
   ...
   max-width: 560px;" class="wrapper">
         ...
         color: #F0F0F0;" class="preheader">
                        ...
                        50%&nbsp;of&nbsp;total email opens occurred on&nbsp;a&nbsp;mobile device&nbsp;—
                        a&nbsp;mobile-friendly design is&nbsp;a&nbsp;must for&nbsp;email campaigns.</div>

                     <!-- LOGO -->
                     <!{{ Campaign- Source}}&utm_medium=email&utm_content=logo&utm_campaign={{ Campaign- Name}} -->
                        <a target="_blank" style="text-decoration: none;"
                           href="${appConfig.origin}"><img border="0" vspace="0" hspace="0"
                              src="https://vshop.blob.core.windows.net/common/v.jpg"
                              width="30" height="30" alt="Logo" title="Logo"
                              style="
            color: #000000;
   ...
   max-width: 560px;" class="container">
         ...
         font-family: sans-serif;" class="subheader">
               ...
               <!-- HERO IMAGE -->
               <!{{ Campaign- Source}}&utm_medium=email&utm_content={{ Ìmage- Name}}&utm_campaign={{ Campaign- Name}}
                  -->
                  <tr>
                     <td align="center" valign="top" style="border-collapse: collapse; border-spacing: 0; margin: 0; padding: 0;
         ...
         font-family: sans-serif;" class="paragraph">
                  ...
                  <!-- BUTTON -->
                  <!{{ Campaign- Source}}&utm_medium=email&utm_content={{ Button- Name}}&utm_campaign={{ Campaign- Name}}
                     -->
                     <tr>
                        <td align="center" valign="top" style="border-collapse: collapse; border-spacing: 0; margin: 0; padding: 0; padding-left: 6.25%; padding-right: 6.25%; width: 87.5%;
         padding-top: 25px;
         padding-bottom: 5px;" class="button"><a href="${appConfig.origin}" target="_blank"
         ...
         padding-top: 25px;" class="line">
                  ...
                  color: #000000;" src="${product.imageUrl}"
                                          alt="H" title="Highly compatible" width="50" height="50"></td>
         ...
         color: #000000;
         font-family: sans-serif;" class="paragraph">
                           Have a&nbsp;question? <a href="mailto:${constants.emails.support}" target="_blank"
                              style="color: #127DB3; font-family: sans-serif; font-size: 17px; font-weight: 400; line-height: 160%;">${constants.emails.support}</a>
                        </td>
                     </tr>
   ...
   max-width: 560px;" class="wrapper">
                     ...
                     <table width="256" border="0" cellpadding="0" cellspacing="0" align="center"
                        ...
                        <tr>
                           ...
                           <td align="center" valign="middle"
                              ...
                              <a target="_blank" href="${constants.links.facebook}"
         ...
         font-family: sans-serif;" class="footer">
                     ...
                     Copyright © ${(new Date).getFullYear()} Vadym Shevchenko. All rights reserved.

                     <!-- ANALYTICS -->
                     <!{{ UA- Tracking - ID}}&cid={{ Client- ID}}&t=event&ec=email&ea=open&cs={{ Campaign- Source}}&cm=email&cn={{ Campaign- Name}}
                        -->
